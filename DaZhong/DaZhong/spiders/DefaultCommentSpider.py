...
class DefaultCommentSpider(Spider):
    name = 'DefaultCommentSpider'
    
    def __init__(self, category=None, *args, **kwargs):
        super(DefaultCommentSpider, self).__init__(*args, **kwargs)
...
##                                arequest1 = Request(url_1,meta={'path':path5_1},callback=self.parse_pagelinks)
##                                arequest2 = Request(url_2,meta={'path':path5_2},callback=self.parse_pagelinks)
